    ...
    public class ProductRepository : IDisposable
    {
        ...
        public void UpdateUsingEntry(Product product)
        {
            ...
            if (anyProductToUpdate)
            {
                ...
                product.ManufacturerId = product.ManufacturerId == default ? productToUpdate.ManufacturerId : product.Id;
        ...
        public IEnumerable<Product> GetByManufacturer(int manufacturerId){
            var products = db.Products.Where(p => p.ManufacturerId == manufacturerId).ToList();
            return products;
        }
